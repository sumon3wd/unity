...
add_action( 'widgets_init', 'geobin_contact_load_widget' );

function geobin_contact_load_widget() {
	register_widget( 'Geobin_Contact' );
}

class Geobin_Contact extends WP_Widget
{
    function __construct() {
        $widget_opt = array(
            'classname'     => 'geobin_widget',
            'description'   => 'Geobin Contact'
        );
        
        parent::__construct('xs-contacts', esc_html__('Geobin Contact', 'geobin'), $widget_opt);
    }
    ...
    function form($instance){
    	if(isset($instance['title'])){
            ...
            $title = esc_html__( 'Contact', 'geobin' );
        }
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'address' )); ?>"><?php esc_html_e( 'Address One:' , 'geobin' ); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'address_one' )); ?>"><?php esc_html_e( 'Address Two:' , 'geobin' ); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'mobile' )); ?>"><?php esc_html_e( 'Mobile:' , 'geobin' ); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'email' )); ?>"><?php esc_html_e( 'Email:' , 'geobin' ); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'fax' )); ?>"><?php esc_html_e( 'Fax:' , 'geobin' ); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'open_time' )); ?>"><?php esc_html_e( 'Open Hour:' , 'geobin' ); ?></label>
