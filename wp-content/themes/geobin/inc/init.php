...
class Geobin_Theme_Includes {
	...
	public static function init() {
		...
		if ( class_exists( 'XsCustomPost\Xs_CustomPost' ) ) {
			...
			$tab = new XsCustomPost\Xs_CustomPost( 'geobin' );
				$tab->xs_init( 'service', 'Service', 'Services', array( 'menu_icon'	 => 'dashicons-exerpt-view',
					'supports'	 => array( 'title', 'editor', 'thumbnail', 'excerpt' ),
					'rewrite'	 =>  array( 'slug' => 'service' ) ));

				$tab->xs_init(
				'projects', 'Project', 'Projects', array( 'menu_icon'	 => 'dashicons-exerpt-view',
					'supports'	 => array( 'title', 'editor', 'thumbnail', 'excerpt' ),
			...
			/**
			 *
			 * Portfolio Custome Post And Taxonomies
			 *
			 */
			$portfolio_tax = new XsCustomPost\Xs_Taxonomies( 'geobin' );
			$portfolio_tax->xs_init( 'portfolio_cat', 'Category', 'Categories', 'projects' );
		}
		 ...
		 */ {
			self::include_child_first( '/includes/xs-image-crop-class.php' );
