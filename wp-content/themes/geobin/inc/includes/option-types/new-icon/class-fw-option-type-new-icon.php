...
class FW_Option_Type_NewIcon extends FW_Option_Type {
	...
	private function generate_unknown_set( $icon ) {
		return array(
			...
			'container-class'	 => '',
			'groups'			 => array(
				'unknown' => esc_html__( 'Unknown Set', 'geobin' ),
			),
			'icons'				 => array(
	...
	private function get_default_sets() {
		return array(
			'font-awesome' => array( // http://fortawesome.github.io/Font-Awesome/icons
				...
				'groups'			 => array(
					'web-application'	 => esc_html__( 'Web Application Icons', 'geobin' ),
					'hand'				 => esc_html__( 'Hand Icons', 'geobin' ),
					'transportation'	 => esc_html__( 'Transportation Icons', 'geobin' ),
					'gender'			 => esc_html__( 'Gender Icons', 'geobin' ),
					'file-type'			 => esc_html__( 'File Type Icons', 'geobin' ),
					'payment'			 => esc_html__( 'Payment Icons', 'geobin' ),
					'currency'			 => esc_html__( 'Currency Icons', 'geobin' ),
					'text-editor'		 => esc_html__( 'Text Editor Icons', 'geobin' ),
					'directional'		 => esc_html__( 'Directional Icons', 'geobin' ),
					'video-player'		 => esc_html__( 'Video Player Icons', 'geobin' ),
					'brand'				 => esc_html__( 'Brand Icons', 'geobin' ),
					'medical'			 => esc_html__( 'Medical Icons', 'geobin' ),
					'finences-icons'	 => esc_html__( 'Finences Icons', 'geobin' ),
				),
				'icons'				 => array(
